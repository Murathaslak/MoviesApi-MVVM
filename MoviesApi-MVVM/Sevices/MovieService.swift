...
final class MovieService {
    ...
    func downloadMovies(page:Int, completion: @escaping ([MovieResult]?) -> ()){
        ...
        // Uygulamada indirme yaparken başka sayfaya geçebiliriz ve bu geçişte indirme arkada devam etmeyebilir
        // ve ramdan silinebilir [weak self] yazarak ramden silme arkada indirme devam etsin diyoruz
